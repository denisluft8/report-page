...
const data = [
  { name: "Excessive defect", value: 30 },
  { name: "Moderate defect", value: 30 },
  { name: "OPTIMAL", value: 10 },
  { name: "", value: 18 },
  { name: "Excess", value: 12 },
];
...
export const BajoPresion = ({ needleData }) => {
  ...
  return (
    <ContainerDiv title="DECISION MAKING UNDER PRESSURE" titleDirection="right">
      <p
        style={{
          color: "#fff",
          width: "100%",
